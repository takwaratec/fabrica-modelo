---
tipo: Ficha Técnica Cavichiolli — Sistema Construtivo Faleiros-Techsus
titulo: Sistema Construtivo Industrializado Techsus — Caracterização Técnica Completa
fontes: Proposta Técnica CDHU Offsite 001/2024 (83p) + Apresentação Techsus (42 slides)
data: 2026-07-07
status: Consolidado
licenca: CC BY 4.0
---
...
```mermaid
graph LR
    A[Cofragem] --> B[Armadura]
    B --> C[Concretagem]
    C --> D[Alisamento]
    D --> E[Cura]
    E --> F[Retirada dos elementos]
```
...
```mermaid
graph TD
    ADMIN["TECHSUS<br/>Central System"] --> FAB1["Fábrica 1"]
    ADMIN --> FAB2["Fábrica 2"]
    ADMIN --> FAB3["Fábrica N"]
    FIN["Financeiro"] --> ADMIN
    FORN["Fornecedores"] --> ADMIN
    TI["T.I."] --> ADMIN
    COMP["Compliance"] --> ADMIN
    FAB1 --> OBRAS["Obras CDHU/MCMV"]
    FAB2 --> OBRAS
    FAB3 --> OBRAS
    OBRAS --> RETRO["Retroalimentação"]
    RETRO --> ADMIN
```
