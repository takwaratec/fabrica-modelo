---
tipo: Rascunho Base — Proposta FINEP Subvenção Econômica (Adaptação do Protocolo Cavichiolli)
projeto: Fábrica Modelo — Sistema Construtivo Faleiros-Techsus + P&D Takwara
data: 2026-07-07
versao: 1.0 — Rascunho para submissão
responsaveis: André Blanco, Maurilio Chiaretti, Fabio Takwara
prazo: 31/08/2026
...
```mermaid
graph TD
    subgraph ENTREGAS["SISTEMA ATUAL (TRL 7)"]
        SIST["Sistema Techsus<br/>PATENTES: BR, EUA, CN<br/>DATec 024-B | CDHU | Caixa"]
        ENS["Ensaios IPT:<br/>Acústica, Durabilidade,<br/>Fogo (60min), Térmico"]
    end

    subgraph P&D["P&D (TRL 7 → TRL 8)"]
        A1["1. Concreto Verde<br/>- Fibras vegetais<br/>- PET reciclado<br/>- Pozolanas"]
        A2["2. Ferragem Otimizada<br/>- Redução de aço<br/>- Bambu resinado<br/>- PU expansivo"]
        A3["3. Impermeabilização<br/>- PU vegetal Imperveg<br/>- Estanqueidade<br/>- Atóxico"]
        A4["4. Acabamentos<br/>- Textura integrada<br/>- Pisos vegetais<br/>- Telha sanduíche"]
    end

    subgraph PROTOTIPOS["PROTÓTIPOS"]
        P1["Casa HHU-TI<br/>MCMV | 41m²"]
        P2["Prédio HVM<br/>CDHU | 4 andares"]
        P3["Autogestão<br/>MST | Mutirão"]
    end

    subgraph CERTIF["CERTIFICAÇÕES"]
        C1["LEED Gold (60+ pts)"]
        C2["Casa Azul Ouro (39+ pts)"]
        C3["AQUA Excelente"]
    end
    ...
    C1 --> ENTREGA["SISTEMA APRIMORADO (TRL 8)<br/>+ PROVA SOCIAL"]
    C2 --> ENTREGA
    C3 --> ENTREGA
```
