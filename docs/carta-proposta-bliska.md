# Carta Proposta — Convite à Parceria com Prof. Antônio Bliska Jr. (UNICAMP)

> **Documento do Grupo Executor Fábrica Modelo**
> **Finalidade:** Convite para integração ao projeto FINEP Mais Inovação — estufas geodésicas, certificação de processos e materiais
> **Data:** Julho/2026
...
- **Índice de fichas do pesquisador no Acervo Científico:** [Bliska — Índice de Fichas](https://github.com/takwaratec/Analises-e-escrita-cientifica/blob/main/docs/analises/08_perfis-referencias/index-bliska.md) (perfil + artigos)
- **Vídeo demonstrativo da geodésica:** [https://youtu.be/OGeVIEGZfb0](https://youtu.be/OGeVIEGZfb0)

---

## Forma de Participação

Considerando as regras do FINEP, a UNICAMP/NIPE atuaria como **ICT parceira** do projeto, com as seguintes possibilidades de participação:

- **Pesquisador colaborador** no escopo de P&D do projeto
- **Orientação técnica** nas linhas de geodésicas, materiais e certificação
...
1. **Apreciação da proposta** pelo Prof. Bliska
2. **Reunião técnica** com André Blanco e Fabio Takwara para detalhamento das frentes de integração
3. **Definição do escopo de participação** e contrapartida da UNICAMP/NIPE
4. **Formalização da parceria** para inclusão na proposta FINEP

---

## Repositórios do Projeto (públicos)

O embasamento científico e os documentos do projeto estão abertos:

| Repositório | Conteúdo | Link |
|-------------|----------|------|
| **fabrica-modelo** | Documentos do projeto: cartas, proposal, formulário espelho | [github.com/takwaratec/fabrica-modelo](https://github.com/takwaratec/fabrica-modelo) |
| **Analises-e-escrita-cientifica** | Acervo científico — 330+ fichas, análises, referências | [github.com/takwaratec/Analises-e-escrita-cientifica](https://github.com/takwaratec/Analises-e-escrita-cientifica) |
